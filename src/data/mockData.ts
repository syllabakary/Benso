...
// Ensure landlord info is added to each property
mockProperties.forEach(property => {
  property.landlord = mockUsers.find(user => user.id === property.landlordId) || null;
});
...
export const mockConversations: Conversation[] = [
  {
    ...
    propertyId: '1',
    property: mockProperties.find(p => p.id === '1') || null,
    lastMessage: {
      id: '1',
      conversationId: '1',
